  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const res = await api.post("/pdf-to-image", formData);
              console.log(
          "Full URL:",
          `${api.defaults.baseURL}/pdf-to-image`
        );
      setImages(res.data.images);
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-500 mt-0.5 mb-3">
                Connect your Google Drive to automatically save converted images to the cloud.
              </p>
              <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 px-6 py-4">
              <div className="flex flex-wrap justify-between items-center gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  {isGoogleConnected && uploadToDrive && (
                    <button
                      onClick={() => images.forEach((img, i) => uploadSingleToDrive(img, i))}
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-500 text-white rounded-lg text-sm hover:bg-indigo-600 transition shadow-sm"
                    >
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            { icon: Shield, label: "High Quality", sub: "Preserve original quality" },
            { icon: CloudUpload, label: "Cloud Backup", sub: "Save to Google Drive" },
            { icon: Clock, label: "Batch Processing", sub: "All pages at once" },
