...
export default function TestPDF() {
  ...
  const testPDF = async () => {
    ...
    try {
      ...
      // FIX: use api (not axios), correct path without /api prefix
      const response = await api.get('/invoice/test-pdf', {
        responseType: 'blob'
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500">Click the button below to generate a test invoice PDF</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-slate-800 mb-2">Test Invoice PDF</h2>
            <p className="text-slate-500 text-sm mb-6">
              Generates a sample invoice with test data to verify PDF generation is working.
            </p>
            <button
              onClick={testPDF}
              disabled={loading}
        ...
        <div className="mt-8 bg-blue-50 rounded-xl p-5 border border-blue-100">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>• Generated PDF should download automatically</li>
            <li>• If PDF fails, check server logs for errors</li>
